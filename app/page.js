    ...
    <main className="min-h-screen bg-white flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="z-10 text-center px-4 w-full flex flex-col items-center">
        <motion.div
          ...
          className="w-full"
        >
          <h1 className="text-5xl font-bold mb-6 text-gray-800">Capturely</h1>
  ...
  >
    ...
    >
      <div className="text-center">
        ...
        <p className="text-xl mb-4">Darell Francisco</p>
      ...
      <div className="mt-2">
        ...
        <div className="flex items-center mb-2 justify-start">
          ...
          <p className="text-black text-opacity-80">darellcfrancisco@gmail.com</p>
        </div>
        ...
        <div className="flex items-center mb-4 justify-start">
          ...
          <p className="text-black text-opacity-80">+63 939-668-4918</p>
        </div>
        
        {/* Social Media Icons */}
        <div className="flex justify-center space-x-6 mt-2">
          {/* Instagram */}
          <a target="_blank" href="https://www.instagram.com/darell.ln?igsh=MXBya3h5MDVpMHFnaA%3D%3D" className="text-black hover:text-blue-500 transition-colors">
          ...
          {/* Facebook */}
          <a target="_blank" href="https://www.facebook.com/1smedar" className="text-black hover:text-blue-500 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          {/* LinkedIn */}
          <a href="https://www.linkedin.com/in/itsdar/" className="text-black hover:text-blue-500 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
